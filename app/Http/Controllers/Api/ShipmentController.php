...
class ShipmentController extends Controller
{
    ...
    public function store(
        ...
        $data = $request->validate([
            ...
            'sender.city' => ['required', 'string', 'max:120'],
            'sender.street' => ['required', 'string', 'max:160'],
            'sender.number' => ['nullable', 'string', 'max:30'],
            'sender.postal_code' => ['required', 'string', 'max:30'],
        ...
        $shipment = DB::transaction(function () use ($data, $pricing, $phones, $passportPath) {
            ...
            return Shipment::create([
                ...
                'sender_number' => $data['sender']['number'] ?? null,
