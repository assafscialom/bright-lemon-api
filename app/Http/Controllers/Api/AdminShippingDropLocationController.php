...
class AdminShippingDropLocationController extends Controller
{
    ...
    private function validatedData(Request $request, ?ShippingDropLocation $location = null): array
    {
        return $request->validate([
            ...
            // Shipper's share (%) of the customer_price for shipments dropped
            // here: shipper_take = customer_price × markup%, branch keeps the
            // rest. 0 = branch keeps the whole customer price.
